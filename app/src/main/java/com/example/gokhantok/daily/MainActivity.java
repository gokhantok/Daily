...
import com.amulyakhare.textdrawable.util.ColorGenerator;import com.example.gokhantok.daily.R;

import org.json.JSONException;

import java.io.IOException;
import java.lang.Override;import java.lang.String;import java.lang.SuppressWarnings;import java.util.ArrayList;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TODOITEM = "com.gokhantok.daily.MainActivity";
...
////            Log.d("Information", "Arraylist Length: "+mToDoItemsArrayList.size());
//        } catch (IOException | JSONException e) {
////            Log.d("Information", "IOException received");
//            e.printStackTrace();
//        }
//
//        if(mToDoItemsArrayList==null){
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(resultCode!= RESULT_CANCELED && requestCode == REQUEST_ID_TODO_ITEM){
            ...
            if(item.hasReminder() && item.getToDoDate()!=null){
                ...
                i.putExtra(TodoNotificationService.TODOUUID, item.getIdentifier());
                createAlarm(i, item.getIdentifier().hashCode(), item.getToDoDate().getTime());
//                Log.d("Information", "Alarm Created: "+item.getToDoText()+" at "+item.getToDoDate());
            }
...
//        Log.d("Information", "createAlarm "+requestCode+" time: "+timeInMillis+" PI "+pi.toString());
    }
    private void deleteAlarm(Intent i, int requestCode){
        if(doesPendingIntentExist(i, requestCode)){
            ...
            Log.d("Information", "PI Cancelled " + doesPendingIntentExist(i, requestCode));
        }
    }
...
//            String toShow = (mJustDeletedToDoItem.getToDoText().length()>20)?mJustDeletedToDoItem.getToDoText().substring(0, 20)+"...":mJustDeletedToDoItem.getToDoText();
            String toShow = "Not";
            Snackbar.make(mCoordLayout, ""+toShow+" silindi",Snackbar.LENGTH_SHORT)
...
//                item.setTodoColor(color+"");
//            }
//            Log.d("Information", "Color: "+item.getTodoColor());
